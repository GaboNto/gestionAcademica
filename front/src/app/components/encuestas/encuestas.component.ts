// Componente principal de gesti�n de encuestas (estudiantiles y colaboradores)
...
// Tipos de encuesta manejados por el m�dulo
...
export class EncuestasComponent implements OnInit {
  // Inyecci�n moderna de FormBuilder
...
downloadEstadisticasEstudiantilesExcel(): void {
  ...
  tiposEncuesta = [
    { value: 'ESTUDIANTIL' as TipoEncuesta, label: 'Percepci�n estudiantil' },
    {
  ...
  // ---------- UI / FORM CONTROL ----------
  // Inicializa el formulario seg�n el tipo de encuesta
  ...
  // Abre modal de edici�n de preguntas abiertas (clonando objeto)
  ...
  // Configuraci�n de orden actual en tabla de encuestas
  orden = {
    campo: 'fecha' as 'fecha' | 'nombre' | 'tipo',
    asc: false,
  };

  // Cambia campo y direcci�n de orden
  ...
  // Calcula semestre (1 o 2) seg�n la fecha de la encuesta
